...
interface ShareAccordProps {
  initialData: Doc<"accords">;
}

export const ShareAccord = ({ initialData }: ShareAccordProps) => {
  ...
  const url = `${origin}/preview/accord/${initialData._id}`;
  ...
  const onPublish = useCallback(() => {
    ...
    toast.promise(promise, {
      loading: "Sharing...",
      success: "Accord shared",
      error: "Failed to share accord.",
    });
  ...
  const onUnpublish = useCallback(() => {
    ...
    toast.promise(promise, {
      loading: "Unsharing...",
      success: "Accord unpublished",
      error: "Failed to unpublish accord.",
    });
  }, [update, initialData._id]);
    ...
    <div className="space-y-4">
      {isPublished ? (
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-sm font-medium mb-2">Share this accord</p>
          <span className="text-xs text-muted-foreground mb-4">
            Share your accord with others.
          </span>
          <Button
            disabled={isSubmitting}
            onClick={onPublish}
    ...
    return (
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogTitle asChild>
            <VisuallyHidden>Share Accord</VisuallyHidden>
          </DialogTitle>
          {shareContent}
        </DialogContent>
      </Dialog>
