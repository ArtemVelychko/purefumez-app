...
export const ShareMaterial = ({ initialData }: ShareMaterialProps) => {
  ...
  const url = `${origin}/preview/material/${initialData._id}`;
  ...
  const onUnpublish = useCallback(() => {
    ...
    toast.promise(promise, {
      loading: "Unsharing...",
      success: "Material unpublished",
      error: "Failed to unpublish material.",
    });
  }, [update, initialData._id]);
    ...
    <div className="space-y-4">
      {initialData.isPublished ? (
        <>
          ...
          <div className="flex items-center">
            ...
            <Button
              onClick={onCopy}
              className={cn(
                "h-8 rounded-l-none transition-all duration-200 ease-in-out",
                copied
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-sm font-medium mb-2">Share this material</p>
          <span className="text-xs text-muted-foreground mb-4">
            Share your material with others.
          </span>
          <Button
            disabled={isSubmitting}
            onClick={onPublish}
    ...
    return (
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogTitle asChild>
            <VisuallyHidden>Share Material</VisuallyHidden>
          </DialogTitle>
          {shareContent}
        </DialogContent>
      </Dialog>
